...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  td {
    ...
    vertical-align: top;
    /* ── WORD WRAP ── */
    white-space: pre-wrap;       /* honour newlines, wrap long text   */
    word-break: break-word;      /* break URLs / paths that have no spaces */
    overflow-wrap: anywhere;     /* last-resort break for solid strings */
    max-width: 420px;            /* cap column width so table stays readable */
    line-height: 1.55;
  }
